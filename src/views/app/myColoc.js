...
<!-- Card pour sélectionner une colocation -->
<div class="bg-white p-6 rounded shadow h-60 w-full mb-5">
    ...
    <div>
      ...
      <select id="coloc" name="coloc" class="mt-1 block w-full border border-gray-300 rounded py-2 px-3 text-black">
        ...
        ${Object.values(colocData.coloc).map((coloc) => `
          <option value="${coloc.coloc_id}">${coloc.coloc_name}</option>
        `).join('')}
      </select>
    </div>
